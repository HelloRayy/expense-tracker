            ...
            <div class="raycast-top-bar">
                ...
                <div class="raycast-categories-container">
                    <div class="raycast-categories" id="raycastCategories">
                        ...
                        <div class="raycast-category-pill" onclick="selectShowcaseCategory(0, 1, this)">
                            Widget Cepat
                        </div>
                        <div class="raycast-category-pill" onclick="selectShowcaseCategory(416, 2, this)">
                            Smart Nudge
                        </div>
                        <div class="raycast-category-pill" onclick="selectShowcaseCategory(832, 3, this)">
                            Amplop Mental
                        </div>
                        <div class="raycast-category-pill" onclick="selectShowcaseCategory(1248, 4, this)">
                            Privasi SQLite
                        </div>
                    </div>
                </div>
