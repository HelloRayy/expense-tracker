...
| Expense recap with period selector (Minggu Ini, Bulan Ini, Semua), category breakdown bar, wallet distribution, and top expenses | Rekap Pengeluaran | `RekapScreen` | [`lib/features/rekap/screens/rekap_screen.dart`](file:///home/rayhan/Windows-D/project/expense-tracker/lib/features/rekap/screens/rekap_screen.dart) | `BudgetRepository` |
